...
bool=True
while bool :
    Taille_enfant = input("Entrez la taille en cm de votre nourrisson : ")
    try:
...
bool=True
while bool :
    Poids_enfant = input("Entrez le poid en kg de votre nourrisson : ")
    try:
        Poids_enfant = float(Poids_enfant)
        bool = False
    except ValueError:
        print("Entrez un nombre.")
...
bool=True
while bool :
    Perim_enfant = input("Entrez le périmètre cranien en cm de votre nourrisson : ")
    try:
...
if Genre == 'un garçon' :
    print(f'la norme de taille pour {Genre} de {Age_enfant} mois  est située entre {low_heights_boys[Age_enfant]} cm et {high_heights_boys[Age_enfant]} cm')
    if Taille_enfant > low_weights_boys[Age_enfant] and  Taille_enfant < high_weights_boys[Age_enfant] :
        print(f'la taille de votre enfant est de {Taille_enfant} kg, il est dans la norme')
    else :
        print(f"la taille de votre enfant est de {Taille_enfant} kg, attention il n'est pas dans la norme \n")
else:
    print(f'la norme de taille pour {Genre} de {Age_enfant} mois  est située entre {low_heights_girls[Age_enfant]} cm et {high_heights_girls[Age_enfant]} cm')
    if Taille_enfant > low_weights_girls[Age_enfant] and  Taille_enfant < high_weights_girls[Age_enfant] :
        print(f'la taille de votre enfant est de {Taille_enfant} cm, il est dans la norme')
    else :
        print(f"la taille de votre enfant est de {Taille_enfant} cm, attention il n'est pas dans la norme \n") 

if Genre == 'un garçon' :
    print(f'la norme de périmètre crânien pour {Genre} de {Age_enfant} mois  est située entre {low_skulls_boys[Age_enfant]} cm et {high_skulls_boys[Age_enfant]} cm')
    if Perim_enfant > low_skulls_boys[Age_enfant] and  Perim_enfant < high_skulls_boys[Age_enfant] :
        print(f'la taille de périmètre crânien est de {Perim_enfant} cm, il est dans la norme')
    else :
        print(f"la taille de périmètre crânien est de {Perim_enfant} cm, attention il n'est pas dans la norme \n")
else:
    print(f'la norme de périmètre crânien pour {Genre} de {Age_enfant} mois  est située entre {low_skulls_girls[Age_enfant]} cm et {high_skulls_girls[Age_enfant]} cm')
    if Perim_enfant > low_skulls_girls[Age_enfant] and  Perim_enfant < high_weights_girls[Age_enfant] :
        print(f'la taille de périmètre crânien est de {Perim_enfant} cm, il est dans la norme')
    else :
        print(f"la taille de périmètre crânien est de {Perim_enfant} cm, attention il n'est pas dans la norme \n") 
